...
static int execute(t_bridge** array_of_bridges, int num_of_bridges, int number_of_islands) {
    struct s_island** islands = (struct s_island**)malloc((2 * num_of_bridges + 1) * sizeof(struct s_island*));
    islands[0] = NULL;
    ...
    // if the number received on the first line does not coincide with the number of islands
...
int main(int argc, char *argv[]) {
    ...
    t_bridge** array_of_bridges = (t_bridge**) malloc((num_of_bridges + 1) * sizeof(t_bridge*));
